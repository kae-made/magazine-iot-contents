...
{
    class MeasurementInstrumentsEdgeAppConnector : Kae.IoT.Framework.IoTAppConnector
    { 
        private IIoTApp iotApp;

        public MeasurementInstrumentsEdgeAppConnector(IoTAppConfig appConfig, IIoTApp app) : base(appConfig)
        {
            iotApp = app;
        }
